...
- 🎯 Entry points to execute your program using `python -m <confitec_teste>` or `$ confitec_teste` with basic CLI argument parsing.
...
```bash
confitec_teste create-db   # run once
confitec_teste populate-db  # run once (optional)
confitec_teste add-user -u admin -p 1234  # ads a user
confitec_teste run
```
